        ...
        >
            <Wrapper>
                ...
                <Div className="mb-10 relative">
                    ...
                    "Welcome to my creative haven, where ideas intertwine and dreams take flight. Join me on a whimsical journey through my portfolio, where pixels paint stories, and imagination dances with code. Let's embark on an adventure of artistry and innovation, and together, we'll shape a world of boundless possibilities."
                    </div>
                </Div>
                {/* SECTION HEADING END */}
