            ...
            <Wrapper>
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>mdreyazansari1818rosra@gmail.com</div>
                    </div>
                ...
                >
                    <h1 className="text-[50px] md:text-[120px] 2xl:text-[189px] leading-[50px] md:leading-[125px]  2xl:leading-[192px] font-oswald  capitalize  hover:text-teal-500 cursor-pointer">
                        I Am A Web
                ...
                >
                    ...
                    <div className="max-w-[550px]  border-transparent hover:border-indigo-900 transition hover:text-cyan-500 rounded-lg pl-3">
                    Welcome to explore my portfolio, where you will find a curated collection of projects that showcase my expertise and passion for web development.
                    </div>
                </motion.div>
                {/* INTRO END */}
                ...
                {/* PERSON BLOCK START */}
                <motion.div
                    className="w-[300px] md:w-[360px] 2xl:w-[340px] absolute bottom-0 left-[80%] -translate-x-1/2"
                    initial={{ y: 200, x: "-50%" }}
                    animate={{ y: 0 }}
                    transition={{ duration: 0.5 }}
                >
