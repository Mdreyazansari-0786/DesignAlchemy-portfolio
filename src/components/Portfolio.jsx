    ...
    return (
        <div id="work" className="mt-10 relative">
            ...
            <Div className="mb-10">
                ...
                Our latest web development project is an innovative and cutting-edge platform that embraces the latest technologies and design trends. With a responsive and dynamic interface, it ensures an engaging and seamless user experience across all devices. 
                </div>
            </Div>
            {/* SECTION HEADING END */}
