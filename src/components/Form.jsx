...
const Form = () => {
    ...
    const formSubmitHandler = (e) => {
        ...
        send(
            "service_m6lv6ek", // Service ID
            "template_j6ss40n", // Template ID
            userInput,
            "A96Hd_WyWXt3Qjpqw" // Public Key - https://dashboard.emailjs.com/admin/account
        )
            .then((response) => {
        ...
        <Div className="max-w-[1200px] mx-auto">
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <input
                            name="from_name"
                            type="text"
                            className="h-[64px] bg-white outline-none border-none text-black px-4 rounded-md"
                            required
                            autoComplete="off"
                            onChange={onChange}
                        />
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <textarea
                        name="message"
                        className="h-[162px] bg-white outline-none border-none text-black p-4 resize-none rounded-md"
                        required
                        onChange={onChange}
                    />
                </div>
                ...
                <button className="bg-[#111111] h-[64px] w-72 max-w-[600px] text-[16px] transition-transform active:scale-[0.95] rounded-md  active:bg-teal-600 justify-center animate-bounce">
