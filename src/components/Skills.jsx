    ...
    return (
        ...
        >
            ...
            <Wrapper>
                ...
                <Div className="grid grid-cols-4 gap-4 md:grid-cols-11 relative pl-28">
                    <SkillIcon path={sk1} />
                    <SkillIcon path={sk2} />
                    <SkillIcon path={sk3} />
                    {/* <SkillIcon path={sk4} /> */}
                ...
                <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
                    ...
                    <div className="md:max-w-[65%] flex flex-col gap-6 md:gap-10">
                        <Service
                            num="1"
                            title="Ui/Ux Design"
                            desc="I believe in the power of simplicity and elegance in design. With each project, I strive to create visually stunning and user-centric solutions that leave a lasting impact"
                            data={[
                                "Prototype",
                                "Wireframe",
                                "User Experience",
                        ...
                        <Service
                            ...
                            desc="Welcome to my portfolio! I am a passionate graphic designer with a keen eye for creativity and aesthetics. Through innovative designs, I strive to visually communicate ideas and create impactful solutions."
                            data={[
                                "Creativity",
                        ...
                        <Service
                            ...
                            desc="Hello! I'm a frontend developer with a passion for creating immersive and intuitive user experiences. With expertise in HTML, CSS, JavaScript, and React, I specialize in transforming designs into pixel-perfect and responsive websites"
                            data={[
                                "Responsive",
                                "Modern",
                                "User Experience",
